            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td> 
                                    <a href="index.php?editElectionPage=1&electionId=<?php echo $row['id'] ?>" class="btn btn-sm btn-warning"> Edit </a>
...
<script>
    ...
    {
        let c = confirm("Are you really want to delete it? If you delete Election all the related candidates will be deleted automatically.");
